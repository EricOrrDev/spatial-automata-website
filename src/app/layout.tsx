  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-industrial-black text-white p-4 z-[100] rounded-md border border-slate-grey"
        >
          Skip to content
        </a>
        <ThemeProvider
