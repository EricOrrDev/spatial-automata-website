    ...
    <div className="min-h-screen bg-industrial-black text-white relative">
      ...
      <main className="max-w-4xl mx-auto px-6 py-20 relative z-10 space-y-12">
        ...
        <section className="bg-industrial-black/80 rounded-3xl md:rounded-4xl shadow-lg p-8 md:p-12 backdrop-blur-sm border border-slate-grey/30">
          <h1 className="text-4xl md:text-5xl font-bold mb-8 text-white leading-tight">About Me</h1>
          <div className="prose prose-invert prose-red max-w-none text-white text-lg space-y-6">
            ...
            <p>
              I&apos;m now a CS student and researcher focused on the intersection of computational geometry, AEC (Architecture, Engineering, and Construction) automation, and AI safety. My work revolves around building deterministic systems for the physical world. I believe that as we move towards AI-driven automation in complex physical environments, we need rigorous mathematical frameworks to ensure safety and reliability.
            </p>
            <p>
            ...
            <p>
              Through Spatial Automata, I explore how we can use hierarchical state machines, spatial computing, and advanced geometry to bridge the gap between non-deterministic AI and high-value physical hardware. My goal is to develop tools that empower designers and transform the way we approach complex problems.
            </p>
            <p>
        ...
        <section className="space-y-6">
          ...
          <Card className="bg-industrial-black/60 border-slate-grey/30 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-white">Bachelors of Science in Computer Science</CardTitle>
              <p className="text-white font-medium opacity-90">Oregon State University - Cascades, Bend Oregon</p>
            </CardHeader>
            <CardContent className="text-white">
...
function ExperienceItem({ title, company, location, period, points }: { title: string, company: string, location: string, period: string, points: string[] }) {
  return (
    <Card className="bg-industrial-black/60 border-slate-grey/30 backdrop-blur-sm">
      <CardHeader>
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-2">
          <div>
            ...
            <p className="text-white font-medium opacity-90">{company} — {location}</p>
          </div>
