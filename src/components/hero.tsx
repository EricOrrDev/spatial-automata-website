  ...
  return (
    <Card className="bg-industrial-black/90 rounded-3xl shadow-lg p-10 text-center backdrop-blur-sm">
      ...
      <p className="text-xl text-white mb-8 max-w-2xl mx-auto">
        Spatial Automata creates specialized SaaS tools for AEC professionals by
        streamlining CAD workflows, automating document review, modernizing data
        management, and ensuring code compliance. Our mission: eliminate
        repetitive work so you can focus on design and delivery.
      </p>
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-md mx-auto">
        ...
        />
        <Button name="EarlyAccessButton" className="px-6 py-3">
          Get Early Access
        </Button>
      </div>
    </Card>
